...
//            dd(checkRequestIsWorkingOrNot());
        ...
        return view('accountant.cds.index', compact('title', 'validator'));
    }
    ...
    public function create()
    {
        ...
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('accountant.cds.edit', compact('title', 'validator', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        $users = User::get();
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('accountant.cds.edit', compact('title', 'validator', 'cds', 'users'));
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->expense_id)) {
            return redirect()->route('accountant.cds.index')->with('m-class', 'success')->with('message', t('Successfully Updated'));
        } else {
            return redirect()->route('accountant.cds.index')->with('m-class', 'success')->with('message', t('Successfully Created'));
        }
    }
