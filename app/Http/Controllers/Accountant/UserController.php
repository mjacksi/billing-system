...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.users.index', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('accountant.users.edit', compact('title', 'validator'));
    }
    ...
    public function edit($id)
    {
        ...
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('accountant.users.edit', compact('title', 'validator', 'users'));
...
//        dd(checkRequestIsWorkingOrNot());
        ...
        if (isset($request->user_id)) {
            return redirect()->route('accountant.users.index')->with('m-class', 'success')->with('message', t('Successfully Updated'));
        } else {
            return redirect()->route('accountant.users.index')->with('m-class', 'success')->with('message', t('Successfully Created'));
        }
    }
