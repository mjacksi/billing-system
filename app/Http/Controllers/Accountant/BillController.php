...
class BillController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.bills.index', compact('title', 'validator'));
    }
    ...
    public function addPayment(Request $request, $id)
    {
        ...
        $bill->payments()->create([
            ...
            'accountant_id' => auth()->guard('accountant')->id(),
            'type' => \App\Models\Payment::BILL,
        ]);
        return redirect()->back()->with('message', t('Payment added successfully'))->with('m-class', 'success');
    }
    ...
    public function create()
    {
        ...
        $users = User::get();
        $items = Item::get();
        return view('accountant.bills.edit', compact('title', 'validator', 'users', 'items'));
    }
    ...
    public function edit($id)
    {
        ...
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('accountant.bills.edit', compact('title', 'validator', 'bill', 'users', 'items'));
...
//        upload files
        ...
        if (isset($request->bill_id)) {
            return redirect()->route('accountant.bills.index')->with('m-class', 'success')->with('message', t('Successfully Updated'));
        } else {
            return redirect()->route('accountant.bills.index')->with('m-class', 'success')->with('message', t('Successfully Created'));
        }
    }
    ...
    public function show($id)
    {
        ...
        $bill = $this->_model->findOrFail($id);
        return view('accountant.bills.show', compact('title', 'bill'));
    }
