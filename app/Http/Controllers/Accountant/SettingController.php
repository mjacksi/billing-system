...
class SettingController extends Controller
{
    ...
    public function home()
    {
        ...
        return view('accountant.home',compact('total_items_cost_before','total_items_cost_after','total_items_cost_wins','clients','bills','cds1','cds2','orders_date'));
    }
...
//
        ...
        return view('accountant.setting.general', compact('title', 'validator'));
    }
    ...
    public function view_profile()
    {
        ...
        return view('accountant.setting.profile', compact('title'));
    }
    ...
    public function profile(Request $request)
    {
        ...
        $this->validationRules['email'] = ['required', 'unique:accountants,email,' . $user->id, new EmailRule()];
