...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.items.index', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.items.edit', compact('title', 'validator'));
    }
    ...
    public function edit($id)
    {
        ...
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('manager.items.edit', compact('title', 'validator', 'items'));
...
//        dd(checkRequestIsWorkingOrNot());
        ...
        if (isset($request->items_id)) {
            return redirect()->route('manager.items.index')->with('m-class', 'success')->with('message', t('Successfully Updated'));
        } else {
            return redirect()->route('manager.items.index')->with('m-class', 'success')->with('message', t('Successfully Created'));
        }
    }
