...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.expenses.index', compact('title'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.expenses.edit', compact('title', 'validator'));
    }
    ...
    public function edit($id)
    {
        ...
        $validator = JsValidator::make($this->validationRules, $this->validationMessages);
        return view('manager.expenses.edit', compact('title', 'validator', 'expense'));
...
//        dd(checkRequestIsWorkingOrNot());
        ...
        $store->save();
        if (isset($request->expense_id)) {
            return redirect()->route('manager.expenses.index')->with('m-class', 'success')->with('message', t('Successfully Updated'));
        } else {
            return redirect()->route('manager.expenses.index')->with('m-class', 'success')->with('message', t('Successfully Created'));
        }
    }
