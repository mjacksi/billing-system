                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('accountant.bills.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("accountant.bills.destroy", ":id") }}';
            ...
            $(document).on('click', '.addPaymentRecord', (function () {
                var id = $(this).data("id");
                console.log(id)
                var url = '{{ route("accountant.bill.addPayment", ":id") }}';
                url = url.replace(':id', id);
            ...
            $(function() {
                $('#Bills-table').DataTable({
                    ...
                    @endif
                    ajax: {
                        url : '{{ route('accountant.bills.index') }}',
                        data: function (d) {
                            d.title = $("#title").val();
                            d.from = $("#from").val();
                            d.to = $("#to").val();
