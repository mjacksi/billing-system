            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  @if(Request::is('accountant/home*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('accountant.home') }}" class="kt-menu__link ">
                        ...
                        @can('items')
                            <li class="kt-menu__item  @if(Request::is('accountant/items*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('accountant.items.index')}}" class="kt-menu__link ">
                        ...
                        @endcan
                        @can('users')
                            <li class="kt-menu__item  @if(Request::is('accountant/users*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('accountant.users.index')}}" class="kt-menu__link ">
                        ...
                        @endcan
                        @can('bills')
                            <li class="kt-menu__item  @if(Request::is('accountant/bills*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('accountant.bills.index')}}" class="kt-menu__link ">
                        ...
                        @endcan
                        @can('expenses')
                            <li class="kt-menu__item  @if(Request::is('accountant/expenses*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('accountant.expenses.index')}}" class="kt-menu__link ">
                        ...
                        @endcan
{{--                        @can('cds')--}}
{{--                            <li class="kt-menu__item  @if(Request::is('accountant/cds*') ) kt-menu__item--active @endif"--}}
{{--                                aria-haspopup="true">--}}
{{--                                <a href="{{route('accountant.cds.index')}}" class="kt-menu__link ">--}}
...
{{--                        @endcan--}}
                        @can('payments')
                            <li class="kt-menu__item  @if(Request::is('accountant/payments*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('accountant.payments.index')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-icon la la-dollar"></i>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div
                            ...
                            <div class="kt-notification">
                                <a href="{{route('accountant.profile.show')}}" class="kt-notification__item">
                                ...
                                <div class="kt-notification__custom kt-space-between">
                                    <form id="logout-form" action="{{ url("/accountant/logout") }}" method="POST"
                                          style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                    <a href="{{ url("/accountant/logout") }}" onclick="event.preventDefault();
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    @if(!Request::is('accountant/home'))
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ url('/accountant/home') }}">{{ t('Home') }}</a>
                                </li>
                                @stack('breadcrumb')
                            </ul>
                        </div>
