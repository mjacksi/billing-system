...
{{--                                <a href="{{ route('accountant.payments.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">--}}
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("accountant.payments.destroy", ":id") }}';
            ...
            $(function() {
                ...
                $('#users-table').DataTable({
                    ...
                    @endif
                    ajax: {
                        url : '{{ route('accountant.payments.index') }}',
                        data: function (d) {
                            d.title = $("#title").val();
                            d.draft = $("#draft").val();
                        }
