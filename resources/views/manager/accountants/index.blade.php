                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.accountants.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("manager.accountants.destroy", ":id") }}';
            ...
            $(function() {
                $('#users-table').DataTable({
                    ...
                    @endif
                    ajax: {
                        url : '{{ route('manager.accountants.index') }}',
                        data: function (d) {
                            d.title = $("#title").val();
                            d.draft = $("#draft").val();
                        }
