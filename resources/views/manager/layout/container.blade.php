            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        ...
                        @can('items')
                            <li class="kt-menu__item  @if(Request::is('manager/items*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.items.index')}}" class="kt-menu__link ">
                        ...
                        @can('expenses')
                            <li class="kt-menu__item  @if(Request::is('manager/expenses*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.expenses.index')}}" class="kt-menu__link ">
                        ...
                        @can('cds')
                            <li class="kt-menu__item  @if(Request::is('manager/cds*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.cds.index')}}" class="kt-menu__link ">
                        ...
                        @endcan
                        @can('cds2')
                            <li class="kt-menu__item  @if(Request::is('manager/cds2*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.cds2.index')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-icon la la-repeat"></i>
                                    <span class="kt-menu__link-text">{{ t('cds2') }}</span>
                                </a>
                            </li>
                        @endcan

                        @can('payments')
                            <li class="kt-menu__item  @if(Request::is('manager/payments*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.payments.index')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-icon la la-dollar"></i>
